 ...
 * @author Lest
 */
public class SelecionarDataView extends javax.swing.JFrame {

    /**
     * Creates new form SelecionarDataView
     */ Connection conn = null;
        Date data;
        Date data2;
        SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
        SimpleDateFormat dfsql = new SimpleDateFormat("yyyy-MM-dd");
    public SelecionarDataView() {
        initComponents();
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(jtfStart, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String date1;
        try {
            date1 = dfsql.format(df.parse(jtfStart.getText()));
         
        data = Date.valueOf(date1);
        date1 = dfsql.format(df.parse(jtfEnd.getText()));
        data2 = Date.valueOf(date1);
        } catch (ParseException ex) {
             Logger.getLogger(SelecionarDataView.class.getName()).log(Level.SEVERE, null, ex);
         }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelecionarDataView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelecionarDataView().setVisible(true);
            }
        });
    }
